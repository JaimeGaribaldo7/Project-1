...
/***/ function(module, exports, __webpack_require__) {
	...
	var checkWinner = function checkWinner(player) {
	  event.preventDefault();
	  var combo1 = gameBoard[0] === player && gameBoard[1] === player && gameBoard[2] === player;
	  var combo2 = gameBoard[3] === player && gameBoard[4] === player && gameBoard[5] === player;
	  var combo3 = gameBoard[6] === player && gameBoard[7] === player && gameBoard[8] === player;
	  var combo4 = gameBoard[0] === player && gameBoard[3] === player && gameBoard[6] === player;
	  var combo5 = gameBoard[0] === player && gameBoard[4] === player && gameBoard[8] === player;
	  var combo6 = gameBoard[1] === player && gameBoard[4] === player && gameBoard[7] === player;
	  var combo7 = gameBoard[2] === player && gameBoard[5] === player && gameBoard[8] === player;
	  var combo8 = gameBoard[6] === player && gameBoard[4] === player && gameBoard[2] === player;
...
/***/ function(module, exports) {
	...
	var app = {
	  ...
	  host: 'https://shrouded-river-18372.herokuapp.com/'
	};
